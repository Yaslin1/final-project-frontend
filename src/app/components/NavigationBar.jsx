        ...
        <div className="h-full flex flex-col bg-white">
          ...
          <nav className="mt-6 h-full flex grow flex-col justify-between">
            <div>
              <div>
                {/* AgendaTab */}
                <Link className="flex items-center justify-start w-full p-4 my-4 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-violet-700 cursor-pointer" href="/agenda">
                ...
                {/* Material Tab */}
                <Link className="flex items-center justify-start w-full p-4 my-4 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-violet-700 cursor-pointer" href="/material">
                  <span className="text-left">
            ...
            <span className="w-full flex justify-end">
              {/* Arrow */}
              <div className={`${showFullNav ? "rotate-0": "rotate-180"} arrow p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-violet-700 cursor-pointer`} href="#"
              onClick={toggleNav}>
