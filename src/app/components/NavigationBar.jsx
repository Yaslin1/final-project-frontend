        ...
        <div className="h-full flex flex-col bg-white dark:bg-gray-700">
          ...
          <nav className="mt-6 h-full flex grow flex-col justify-between">
            <div>
              <div>
                {/* AgendaTab */}
                <a className="flex items-center justify-start w-full p-4 my-4 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500 cursor-pointer" href="#">
                  ...
                  <span className= {`${showFullNav ? "block": "hidden"} mx-4 text-sm font-normal`}>
                    Agenda
                  </span>
                </a>
                {/* Material Tab */}
            ...
            <span className="w-full flex justify-end">
              ...
              onClick={toggleNav}>
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
